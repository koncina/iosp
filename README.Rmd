...
The goal of **iosp** is to extends [ioslides_presentation](http://rmarkdown.rstudio.com/ioslides_presentation_format.html) with a custom `css` and a fixed prettyprint javascript
